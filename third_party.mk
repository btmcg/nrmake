...
CATCH := third_party/catch2/2.13.1/single_include
...
ifeq ($(COMPILER),gcc)
  GOOGLE_BENCHMARK := third_party/google-benchmark-gcc/1.5.2
else
  GOOGLE_BENCHMARK := third_party/google-benchmark-clang/1.5.2
endif
